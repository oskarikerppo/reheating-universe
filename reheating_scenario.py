...
def generate_datapoints():
	...
	max_mass = -7
	min_mass = -9
	mass_points = np.logspace(min_mass, max_mass, 8, endpoint=True, base=10)
	...
	min_b = -1
	max_b = 0.3
	b_points = np.logspace(min_b, max_b, 8, endpoint=True, base=10)
...
'''
d = (1.1*t_0, t_0, 1e-09, 1.0000000000000002e-12, 1000.0, 0.0, 1.0, True)
print(reheating_time_star(d))
'''
